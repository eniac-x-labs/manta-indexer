...
import (
	...
	event_watcher "github.com/eniac-x-labs/manta-indexer"
	"github.com/eniac-x-labs/manta-indexer/api"
	"github.com/eniac-x-labs/manta-indexer/common/cliapp"
	...
	flag2 "github.com/eniac-x-labs/manta-indexer/flags"
)
...
func runIndexer(ctx *cli.Context, shutdown context.CancelCauseFunc) (cliapp.Lifecycle, error) {
	...
	return event_watcher.NewMantaIndexer(ctx.Context, &cfg, shutdown)
}
